    ...
    useEffect(() => {
        const fetchProducts = async () => {
            try {
                ...
                // Filtrer uniquement les produits de la catégorie "chaussures"
                const chaussuresProducts = data.filter(
                    (product: Product) =>
                        product.category?.toLowerCase() === "chaussures"
                );

                setProducts(chaussuresProducts);

                // Calculer le prix maximum pour la barre de progression
                const maxProductPrice = Math.max(
                    ...chaussuresProducts.map((p: Product) => p.price)
                );
        ...
        <div className="container py-5">
            <div className="row">
                ...
                <div className="col-lg-9">
                    {/* Hero Section */}
                    <div className="p-5 mb-4 bg-danger bg-gradient text-white rounded-3">
                        <div className="container-fluid py-5">
                            <h1 className="display-4 fw-bold">
                                Notre Collection de Chaussures
                            </h1>
                            <p className="col-md-8 fs-4">
                                Découvrez notre sélection de chaussures
                    ...
                    <div className="mb-5">
                        <h2 className="h3 mb-3">Nos Chaussures</h2>
