      ...
      <div className="row g-4 mb-4">
          ...
          <div className="card h-100 border-0 shadow-sm">
            <div className="card-body">
              <div className="d-flex justify-content-between align-items-center mb-3">
                <h6 className="card-subtitle text-muted">Total Produits</h6>
                <i className="bi bi-box-seam text-primary fs-4"></i>
              </div>
              <h2 className="card-title mb-3">{stats.totalProducts}</h2>
              <Link
                to="/admin/products"
        ...
        <div className="col-md-6 col-lg-3">
          <div className="card h-100 border-0 shadow-sm">
            <div className="card-body">
              <div className="d-flex justify-content-between align-items-center mb-3">
                <h6 className="card-subtitle text-muted">Utilisateurs</h6>
                <i className="bi bi-people text-success fs-4"></i>
              </div>
              <h2 className="card-title mb-3">{stats.totalUsers}</h2>
              <Link
                to="/admin/users"
                className="btn btn-link text-decoration-none p-0"
              >
        ...
        <div className="col-md-6 col-lg-3">
          <div className="card h-100 border-0 shadow-sm">
            <div className="card-body">
              <div className="d-flex justify-content-between align-items-center mb-3">
                <h6 className="card-subtitle text-muted">Stock Faible</h6>
                <i className="bi bi-exclamation-triangle text-warning fs-4"></i>
              </div>
              <h2 className="card-title mb-3 text-warning">{stats.lowStock}</h2>
              <Link
                to="/admin/products"
                className="btn btn-link text-decoration-none p-0"
              >
                Voir les produits <i className="bi bi-arrow-right ms-1"></i>
              </Link>
            </div>
          </div>
        </div>
        ...
        <div className="col-md-6 col-lg-3">
          <div className="card h-100 border-0 shadow-sm">
            <div className="card-body">
              <div className="d-flex justify-content-between align-items-center mb-3">
                <h6 className="card-subtitle text-muted">Commandes Récentes</h6>
                <i className="bi bi-cart text-info fs-4"></i>
              </div>
              <h2 className="card-title mb-3">{stats.recentOrders}</h2>
            ...
            <div className="col-md-4">
              ...
              >
                <div className="card-body text-center">
                  ...
                  <h5 className="card-title">Gérer le Stock</h5>
                  <p className="card-text text-muted">
