    ...
    useEffect(() => {
        const fetchProducts = async () => {
            try {
                ...
                // Filtrer uniquement les produits de la catégorie "bijoux"
                const bijouxProducts = data.filter(
                    (product: Product) =>
                        product.category?.toLowerCase() === "bijoux"
                );

                setProducts(bijouxProducts);

                // Calculer le prix maximum pour la barre de progression
                const maxProductPrice = Math.max(
                    ...bijouxProducts.map((p: Product) => p.price)
                );
        ...
        <div className="container py-5">
            <div className="row">
                ...
                <div className="col-lg-9">
                    ...
                    <div className="p-5 mb-4 bg-warning bg-gradient text-black rounded-3">
                        <div className="container-fluid py-5">
                            ...
                            <p className="col-md-8 fs-4">
                                Découvrez notre sélection de bijoux élégants et
                                raffinés
                            </p>
                        </div>
                    </div>
                    ...
                    {/* Tous les bijoux */}
                    <div className="mb-5">
                        <h2 className="h3 mb-3">Nos Bijoux</h2>
